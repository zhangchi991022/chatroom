...
class AddFrame(MyFrame):
    def __init__(self):
        super().__init__(title='添加好友', size=(340, 330))
        ...
        topimage = wx.Image('resources/images/111.png', wx.BITMAP_TYPE_PNG).ConvertToBitmap()
        topimage_sb = wx.StaticBitmap(self.contentpanel, -1, topimage, pos=(10, 10), size=(500, 120))   #决定了初始topimage_sb的大小
        ...
        img_ori = wx.Image('resources/images/111.png', wx.BITMAP_TYPE_PNG)
        topimage_sb .SetBitmap(resizeBitmap(img_ori, 340, 220))      #重新调整图片的大小但是不能超过初始值
